 ...
 * tracking fact provenance and quality.
 *
 * Confidence levels:
 ...
 *
 * Source types (git-mem specific):
 * - user-explicit: User directly stated via `git mem remember`
 * - commit-trailer: Extracted from AI-* commit trailers
 * - git-note: Stored in refs/notes/mem
 * - retrofit: Generated by retrofitting existing history
