 ...
 * to identify which commits warrant enrichment/annotation.
 */
...
export interface ITriageResult {
  ...
  /** High-interest commits queued for enrichment. */
 ...
 *
 * Scans git history to identify commits worth investigating.
 */
export interface IGitTriageService {
   ...
   * @param isTagAdjacent - Pre-computed tag adjacency.
